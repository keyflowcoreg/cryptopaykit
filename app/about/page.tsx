...
const ECOSYSTEM = [
  ...
  { name: 'CryptoPayKit', desc: 'x402 crypto payment toolkit', href: 'https://cryptopaykit.vercel.app', active: true },
    ...
    <div className="min-h-screen bg-zinc-950">
      <div className="max-w-3xl mx-auto px-6 py-24">
        ...
        <motion.div {...fadeUp} transition={{ delay: 0.1 }} className="mb-16">
          <Link href="/" className="text-sm text-zinc-500 hover:text-white transition-colors mb-8 inline-block">&larr; Back to CryptoPayKit</Link>
          <h1 className="text-4xl font-bold text-white mb-4">About CryptoPayKit</h1>
        ...
        <motion.section {...fadeUp} transition={{ delay: 0.2 }} className="mb-16">
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8">
            <p className="text-zinc-300 leading-relaxed mb-4">
              AI Business Factory builds developer tools powered by AI. We believe the x402 protocol is the future of internet-native payments, and every developer should be able to integrate crypto payments in minutes, not weeks.
            </p>
            <p className="text-zinc-300 leading-relaxed">
              CryptoPayKit provides production-ready templates for Next.js, Express, Cloudflare Workers, and Fastify — plus guides, testing tools, and deployment checklists to go from zero to live in a single afternoon.
            </p>
          </div>
        </motion.section>
            ...
            {ECOSYSTEM.map((product) => (
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  ...
                  {product.active && (
                    <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-amber-500/20 text-amber-400">You are here</span>
                  )}
                </div>
